...
## See http://eqtl.brainseq.org/phase2/ for more details about the
## origin of this file.
download.file(
    "https://s3.us-east-2.amazonaws.com/libd-brainseq2/rse_gene_unfiltered.Rdata",
    here::here("inst", "extdata", "BSP2_rse_gene_unfiltered.Rdata")
)

library("SummarizedExperiment")
load(here::here("inst", "extdata", "BSP2_rse_gene_unfiltered.Rdata"), verbose = TRUE)

rse_gene
metadata(rse_gene) <- list(
    "Downloaded_from" = "http://eqtl.brainseq.org/phase2/",
    "Download_date" = "2023-02-17",
    "Cite_this_paper" = "https://doi.org/10.1016/j.neuron.2019.05.013"
)

save(
    rse_gene,
    file = here::here("inst", "extdata", "BSP2_rse_gene_unfiltered.Rdata")
)
